...
import { AdmindAddNewProduct, deleteProduct, fetchAllOrders, fetchAllUsers, updateOrderStatus } from "../controller/Admin.js";
...
router.put("/order/edit/status", isAuthenticateUser, userIsAdmin, updateOrderStatus);
